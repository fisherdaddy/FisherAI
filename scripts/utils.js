 ...
 * @returns 
 */
function generateLLMContent(inputText, base64Images=[]) {
  // 兼容 OpenAI 的格式
  let contentForOpenAI = inputText;
  ...
  base64Images.forEach(imageBase64 => {
    ...
    return {
      contentForOpenAI: contentForOpenAI,
      contentForGemini: contentForGemini
    };
  }